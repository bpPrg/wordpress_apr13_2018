...
//$howdy = sprintf( __('Poudel, %1$s'), $current_user->display_name );
$howdy = sprintf( __('Wikiceleb %1$s'), '' );
...
function wpfme_footer_admin () {
	echo '&copy; <a href="#" target="_blank">Wikiceleb</a>';
}
 ...
 */
/*
 * Below this are the original functions defined by this theme.
 */
