...
class klean_blog_dashboard {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'klean_blog_enqueue_scripts' ) );
	}
	 ...
	 * Show dashboard page.
	 */
	public function klean_blog_render() {
		?>
	 ...
	 */
	public function klean_blog_enqueue_scripts( $hook ) {
