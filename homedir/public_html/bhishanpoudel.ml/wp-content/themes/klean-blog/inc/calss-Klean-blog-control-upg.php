...
if ( ! class_exists( 'Klean_blog_Control_Upg' ) ) :

	/**
	 * Klean_blog_Control_Upg class.
	 */
	class Klean_blog_Control_Upg extends WP_Customize_Control {
		 ...
		 */
		public $type = 'klean_blog-control-pro';
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Klean_blog_Control_Upg' );
		...
		public function content_template() {
			?>
			<div class="klean-blog">
				<# if ( data.options ) { #>
					<ul class="klean-blog-features">
						...
						<# if ( data.button_text && data.button_url ) { #>
							...
							<# } #>
								...
								<# if ( data.explained_features.length > 0 ) { #>
									...
									<ul class="klean-blog-feature-list">
