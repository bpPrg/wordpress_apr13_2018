...
class Wphigh_Bootstrap_Init extends Wphigh_Bootstrap_Basic {
	 ...
	 * @since 1.0.0
	 */
 	public function __construct( $dir, $dir_uri, $version ) {
		$this->dir     = $dir;
	...
	public function register_scripts() {
		if ( is_rtl() ) {
			wp_register_style( 'radar-bootstrap', $this->dir_uri . '/bs-dist/css/bootstrap-rtl.min.css', '', $this->version );
		} else {
			wp_register_style( 'radar-bootstrap', $this->dir_uri . '/bs-dist/css/bootstrap.min.css', '', $this->version );
		}
		
		wp_register_script( 'radar-bootstrap', $this->dir_uri . '/bs-dist/js/bootstrap.min.js', array( 'jquery' ), $this->version, true );
		wp_register_script( 'radar-bootstrap-paginate-responsive', $this->dir_uri . '/others/responsive-paginate.min.js', array( 'jquery', 'radar-bootstrap' ), $this->version, true );
	}		
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'radar-bootstrap' );
		wp_enqueue_script( 'radar-bootstrap' );
		
		wp_enqueue_script( 'radar-bootstrap-paginate-responsive' );
	}
	...
	public function the_content_more_link( $more_link_text ) {
		$more_link_text = $this->get_button( __( 'Read more' , 'radar' ), array(
	...
	public function excerpt_more( $more ) {
		$button = $this->get_button( __( 'Read more' , 'radar' ), array(
