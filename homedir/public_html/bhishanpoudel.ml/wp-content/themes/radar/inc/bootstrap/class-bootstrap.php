...
class Wphigh_Bootstrap extends Wphigh_Bootstrap_Init {
	...
	public function nav_menu( $args = array() ) {
		...
		$output .= '<div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#' . $args['container_id'] . '"><span class="sr-only">' . __( 'Toggle navigation', 'radar' ) . '</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>' . $brand . '</div>' . "\n";
