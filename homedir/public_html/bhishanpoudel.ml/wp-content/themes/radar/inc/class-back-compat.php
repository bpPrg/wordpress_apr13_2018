...
class Wphigh_Back_Compat {
	 ...
	 * @since 1.0.0
	 */
	public function __construct( $min_version ) {
		$current_theme = wp_get_theme();
		$theme_name = $current_theme->Name;	
		global $wp_version;
		
		$this->message = sprintf( __( '%s requires at least WordPress version %s. You are running version %s. Please upgrade and try again.', 'radar' ), $theme_name, $min_version, $wp_version );
