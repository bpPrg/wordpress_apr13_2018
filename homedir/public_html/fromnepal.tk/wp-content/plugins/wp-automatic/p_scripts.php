...
function wp_automatic_front_end_scripts(){
	...
	if(is_single()){
		...
		//custom gallery style
	 	wp_enqueue_style('wp_automatic_gallery_style',plugins_url( '/css/wp-automatic.css' , __FILE__ ));
...
function wp_automatic_admin_scripts() {
	...
	if( 'wp_automatic' == $post_type ){
		...
		wp_enqueue_style('wp_automatic_basic_styles', plugins_url('css/style.css',__FILE__)) ;
		...
		wp_enqueue_script('wp_automatic_unifom_script',plugins_url('js/jquery.uniform.min.js',__FILE__)  ,array() , '1.1.0');
		wp_enqueue_script('wp_automatic_jqtools_script',plugins_url('js/jquery.tools.js',__FILE__));
		wp_enqueue_script('wp_automatic_main_script',plugins_url('js/main.js',__FILE__),array(),'1.4.0');
