...
if (count($res) > 0 ){
	...
	if (isset ( $res->post_name ))
		...
		if(in_array('OPT_STRIP_CSS', $camp_options_arr) && ! is_array($camp_general['cg_feed_custom_strip_id'])){
...
<br><a href="[source_link]">Source</a> by <a href="[author_link]">[author_name]</a>';
		...
		$camp_general['cg_eb_full_img_t']= $camp_general['cg_am_full_img_t'] =   '<img src="[img_src]" class="wp_automatic_gallery" />';
		$camp_general['cg_it_full_img_t']= $camp_general['cg_it_full_img_t'] =   '<img src="[img_src]" />';
	...
	<input type="hidden" value="<?php   echo $post_id ?>" id="wp_automatic_post_id" />
		...
		<div id="field-camp_type-container" class="field f_100" style="margin-top:10px" >
			...
			<select <?php if(count($res) != 0)   echo 'disabled="disabled"' ?> name="camp_type" id="camp_type">
				...
				<option  value="Single"  <?php @wp_automatic_opt_selected('Single',$camp_type) ?> >Single Scraper</option>
			</select>
		...
		<!-- Feed part -->
			                        ...
			                        <div  class="field f_100">
										...
										<label>Extraction method</label>
										 <select class="select_control_div" name="cg_feed_extraction_method">
										 	...
										 	<option value="summary" <?php @wp_automatic_opt_selected('summary',$camp_general['cg_feed_extraction_method']) ?>>Post content from feed as-is   </option>
								               ...
								               <label for="field6">
								                ...
								                <table>
						 		 		 			...
						 		 		 			<tr>
						 		 		 				...
						 		 		 				<td   style="min-width:65px;padding-right:15px">
						 		 		 				...
						 		 		 				<td  style="padding-right:10px;width:130px" >
						 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_feed_custom_id_single ?>" name="cg_feed_custom_id[]" type="text">
						 		 		 				</td>
								            ...
								            <div id="feed_visual" class="select_control_div_div cg_feed_extraction_method cg_feed_extraction_method_visual field f_100">
											  ...
											  <table>
											 		 		 			...
											 		 		 			<tr>
											 		 		 				...
											 		 		 				<td    style="padding-left:15px;padding-top:8px;" > 
											 		 		 					 <button  title="Locate" data-popup-field-name="feeds" data-popup-field-rss="yes" class="visual_selector" >.</button>
											 		 		 				</td>
						               ...
						               <div  class="field f_100">
						               		...
						               		<div class="option clearfix">
							                    ...
							                    <span class="option-title">
														Specific extraction to a custom field, excerpt or tags
							                    </span>
							                    <br>
									            ...
									            <div id="wp_auatomatic_part_to_field" class="field f_100">
												    	...
												    	<br>If customFieldName is excerpt, then the extracted part will be set as an excerpt and if customFieldName is tags, the extracted part will be set as tags
												    	</i>
								                ...
								                <table>
								                	<tr>
								                		...
								                		<td    style="padding-left:15px;padding-top:8px;padding-right:10px"   valign="top">
					 		 		 					 <button  title="Locate"  data-popup-field-name="feeds" data-popup-field-rss="yes"  class="visual_selector tag_locator" >.</button>
					 		 		 				</td>
							               ...
							               <div class="option clearfix">
								                ...
								                <table>
								                	<tr>
								                		...
								                		<td    style="padding-left:15px;padding-top:8px;padding-right:10px"   valign="top">
					 		 		 					 <button  title="Locate"  data-popup-field-name="feeds" data-popup-field-rss="yes"  class="visual_selector author_locator" >.</button>
					 		 		 				</td>
		 ...
		 <!--  Single Scraper -->
		  <div  class="field  typepart Single" style="display:none;" >
		 		...
		 		<div class="field f_100">
			 		<label>Source URL</label> <input value="<?php  echo @$camp_general['cg_sn_source']   ?>" name="cg_sn_source" type="text">	 
				</div>
				...
				<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_sn_ttl_method cg_sn_ttl_method_visual field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td    style="padding-left:15px;padding-top:8px;" >
 		 		 					 <button  title="Locate" data-popup-field-name="cg_sn_source" class="visual_selector" >.</button>
 		 		 				</td>
					...
					<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_sn_cnt_method cg_sn_cnt_method_css field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:150px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_sn_cnt_css_rule  ?>" name="cg_sn_cnt_css[]" type="text">
 		 		 				</td>
				...
				<div style="margin-top:0;padding-top:0;padding-bottom:20px" class="select_control_div_div cg_sn_cnt_method cg_sn_cnt_method_regex field f_100">
 		 		 		...
 		 		 		<table>
 		 		 			...
 		 		 			<tr>
 		 		 				...
 		 		 				<td  style="padding-right:10px;width:300px" >
 		 		 				 		<input  class="no-unify"  value="<?php  echo $cg_sn_cnt_regex_rule  ?>" name="cg_sn_cnt_regex[]" type="text">
 		 		 				</td>
		 ...
		 <div  class="field f_100">
	         ...
	         <div class="option clearfix">
	          ...
	          <div class="option clearfix">
				...
				<select name="cg_fb_from">
				 	<option value="posts" <?php @wp_automatic_opt_selected('posts',$camp_general['cg_fb_from']) ?>>Page posts</option>
               ...
               <div class="option clearfix">
		            ...
		            <div id="am_full_img_t" class="field f_100">
		               <label for="field6">
		                ...
		                <input value="<?php    echo htmlentities(@$camp_general['cg_am_full_img_t'],ENT_COMPAT, 'UTF-8')   ?>"  name="cg_am_full_img_t" type="text">
               ...
               <div class="option clearfix">
       			...
       			<div class="option clearfix">
                    ...
                    <div id="wp_pinterest_title_count" class="field f_100">
                    	<lable>Limit title to xx chars (default is 80 )</lable>
		 ...
		 <div class="typepart Instagram" style="display:none">
		 		...
		 		<div  class="field f_100">
                	...
                	<div class="option clearfix">
				        ...
				        <div id="IT_SLIDER_c" class="field f_100">
				        	    ...
				        	    <label>Single Image Html</label> 
				        	     ...
				        	     <input value="<?php    echo  htmlentities($camp_general['cg_it_full_img_t'],ENT_COMPAT, 'UTF-8')   ?>"  name="cg_it_full_img_t" type="text">
	               ...
	               <div class="option clearfix">
	                    <input name="camp_options[]"  value="OPT_IT_VID_AUTO" type="checkbox">
	                    <span class="option-title">
								Auto play embeded videos
	                    </span>
	                    <br>
...
<br><a href="[item_link]"><img src="https://i.imgur.com/SUv4PIl.png"></a> 
[ad_1]
[item_description]
<br>[ad_2]</div>		
